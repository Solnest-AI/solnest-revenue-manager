...
> Update my Solnest Revenue Manager. Follow the instructions at https://raw.githubusercontent.com/Solnest-AI/solnest-revenue-manager/main/UPDATE.md exactly.

Claude pulls the latest version and installs it. **Your API keys are preserved** — all five connections keep working. You won't have to re-enter anything.
